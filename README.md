...
* **Handwritten Digit Recognition (AI/ML):** Built a CNN (Python/Jupyter) to classify MNIST digits, implementing data preprocessing and model evaluation.
* **N-Queens Problem Solver (AI Algorithms):** Implemented 4 AI search algorithms (DFS, Genetic Algorithm, etc.) to solve the N-Queens problem and analyzed performance metrics.
